...
public class CadastroCandidatoParseReceitasDespesas extends CadastroParseReceitasDespesas<Candidato> {

	public CadastroCandidatoParseReceitasDespesas(String tipoArquivo, String ano)
